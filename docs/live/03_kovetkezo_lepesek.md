...
- ACTIVE: **integrációs tesztek** (`spa-oidc-config`, `admin/observability`, `admin/upgrade-runs`, `admin/installation`, `admin/audit`, `admin/tenants`, `bff`, …); **66+** supply-chain / termék — [`roadmap-iter-65-plus.md`](roadmap-iter-65-plus.md); **65** ✅ (**PR #112–114**); **64** ✅ (**PR #106–110**); **63** ✅ (**PR #102–105**); **62c+ e2e** backlog; **58c+** touch (**PR #99**); **58c+ CDK** defer — [`workflow-visual-builder.md`](workflow-visual-builder.md); **62c** + **62c+ doksi** (**PR #93**, **PR #95**, **PR #97**); **62b2** mergeelve; **62** / **61** lezárva
