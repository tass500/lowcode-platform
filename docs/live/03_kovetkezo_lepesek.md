...
- ACTIVE: **minőség 68+** (**68a–j**) [`roadmap-iter-68-quality.md`](roadmap-iter-68-quality.md) · **termék 67 (a–d)** ✅ [`roadmap-iter-67-product.md`](roadmap-iter-67-product.md); **66+** enterprise ✅; integrációs tesztek (fő sor lefedve: admin/*, BFF, …); **65** ✅ (**PR #112–114**); **64** ✅ (**PR #106–110**); **63** ✅ (**PR #102–105**); **62c+ e2e** backlog; **58c+** touch (**PR #99**); **58c+ CDK** defer — [`workflow-visual-builder.md`](workflow-visual-builder.md); **62c** + **62c+ doksi** (**PR #93**, **PR #95**, **PR #97**); **62b2** mergeelve; **62** / **61** lezárva
