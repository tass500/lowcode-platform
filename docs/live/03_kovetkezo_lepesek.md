...
- ACTIVE: **65b** (deprecation fejlécek); **65a** ✅ **PR #112**; **64** ✅ (**PR #106–110**); **63** ✅ (**PR #102–105**); **62c+ e2e** backlog; **58c+** touch (**PR #99**); **58c+ CDK** defer — [`workflow-visual-builder.md`](workflow-visual-builder.md); **62c** + **62c+ doksi** (**PR #93**, **PR #95**, **PR #97**); **62b2** mergeelve; **62** / **61** lezárva
