...
**ACTIVE: Iteráció 39 — context var UX: hiba részletek (melyik step/config path mezőben volt a hiba) + UI megjelenítés**
...
- Következő teendő (Iteráció 39): commit slice (backend+tests / docs) → push → PR nyitás
