...
- **Backend (ASP.NET Core)**
  ...
  - **CI SBOM (66+):** `CI` workflow — **CycloneDX JSON** a `LowCodePlatform.Backend.csproj`-ből; eszköz rögzítve `.config/dotnet-tools.json`; artefakt: `sbom-backend-cyclonedx-json` — [`ci-sbom.md`](ci-sbom.md).
