...
- **Frontend (Angular)**
  - **E2E smoke (Playwright):** `frontend/e2e/smoke.spec.ts` — `/` → workflows, **Workflows** / **Entities** / **Workflow runs** / **`/lowcode/auth`** (dev fejléc); CI: `scripts/e2e-smoke-ci.sh` + **`frontend-e2e`** — [`e2e-smoke-plan.md`](e2e-smoke-plan.md).
