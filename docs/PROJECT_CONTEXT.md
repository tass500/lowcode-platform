...
- **Iter 63 (63a–d):** lezárva — [`live/roadmap-next-iterations.md`](live/roadmap-next-iterations.md) (e2e 63d: dokumentált defer).
- **Iter 64+ (enterprise baseline):** hullám **lezárva** (**64a–e**, **PR #106–110**) — [`live/roadmap-iter-64-plus.md`](live/roadmap-iter-64-plus.md) — HTTP fejlécek / HSTS: [`live/security-http-headers.md`](live/security-http-headers.md); Kestrel body limit: [`live/kestrel-request-limits.md`](live/kestrel-request-limits.md); rate limiting: [`live/rate-limiting.md`](live/rate-limiting.md); security audit log: [`live/security-audit-logging.md`](live/security-audit-logging.md); CI `dotnet format`: [`live/ci-dotnet-format.md`](live/ci-dotnet-format.md).
- **Iter 65+ (API életciklus):** hullám **lezárva** (**65a–c**, **PR #112–114**) — [`live/roadmap-iter-65-plus.md`](live/roadmap-iter-65-plus.md) · [`live/api-lifecycle-headers.md`](live/api-lifecycle-headers.md). Következő fókusz: `docs/live/03_kovetkezo_lepesek.md` (integrációs tesztek bővítése; ajánlás: ugyanott a roadmap § *Következő lépés*).
