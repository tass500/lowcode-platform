...
- **Iter 64+ (enterprise baseline):** hullám **lezárva** (**64a–e**, **PR #106–110**) — [`live/roadmap-iter-64-plus.md`](live/roadmap-iter-64-plus.md) — HTTP fejlécek / HSTS: [`live/security-http-headers.md`](live/security-http-headers.md); Kestrel body limit: [`live/kestrel-request-limits.md`](live/kestrel-request-limits.md); rate limiting: [`live/rate-limiting.md`](live/rate-limiting.md); security audit log: [`live/security-audit-logging.md`](live/security-audit-logging.md); CI `dotnet format`: [`live/ci-dotnet-format.md`](live/ci-dotnet-format.md). Következő szállítási fókusz: `docs/live/03_kovetkezo_lepesek.md` (**TBD**).
