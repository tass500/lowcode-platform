...
- **Iter 65+ (API életciklus):** [`live/roadmap-iter-65-plus.md`](live/roadmap-iter-65-plus.md) — **65a** (**PR #112**); **65b** (**PR #113**); **65c** OpenAPI `deprecated`: [`live/api-lifecycle-headers.md`](live/api-lifecycle-headers.md). Napi WIP: `docs/live/03_kovetkezo_lepesek.md`.
