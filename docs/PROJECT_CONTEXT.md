...
- **Iter 63 (63a–d):** lezárva — [`live/roadmap-next-iterations.md`](live/roadmap-next-iterations.md) (e2e 63d: dokumentált defer). Következő hullám: **TBD** — `docs/live/03_kovetkezo_lepesek.md`.
