...
- **Iter 65+ (API életciklus):** hullám **lezárva** (**65a–c**, **PR #112–114**) — [`live/roadmap-iter-65-plus.md`](live/roadmap-iter-65-plus.md) · [`live/api-lifecycle-headers.md`](live/api-lifecycle-headers.md). Következő fókusz: `docs/live/03_kovetkezo_lepesek.md` (**TBD**; ajánlás: ugyanott a roadmap § *Következő lépés*).
