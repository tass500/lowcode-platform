...
- **Iter 64+ (enterprise baseline):** [`live/roadmap-iter-64-plus.md`](live/roadmap-iter-64-plus.md) — HTTP fejlécek / HSTS: [`live/security-http-headers.md`](live/security-http-headers.md); Kestrel body limit: [`live/kestrel-request-limits.md`](live/kestrel-request-limits.md). Napi WIP: `docs/live/03_kovetkezo_lepesek.md`.
