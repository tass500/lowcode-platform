...
- **Iter 65+ (API életciklus):** [`live/roadmap-iter-65-plus.md`](live/roadmap-iter-65-plus.md) — `X-API-Version` / később deprecation: [`live/api-lifecycle-headers.md`](live/api-lifecycle-headers.md). Napi WIP: `docs/live/03_kovetkezo_lepesek.md`.
