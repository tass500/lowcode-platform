...
- **Következő auth keményítés (62c, terv):** BFF + **httpOnly** cookie session — [`live/auth-bff-httponly.md`](live/auth-bff-httponly.md) (a jelenlegi SPA token tárolás szándékosan dev-barát).
