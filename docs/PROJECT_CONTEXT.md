...
- **Iter 65+ (API életciklus):** [`live/roadmap-iter-65-plus.md`](live/roadmap-iter-65-plus.md) — **65a** `X-API-Version` (**PR #112**); **65b** `Deprecation`/`Sunset`: [`live/api-lifecycle-headers.md`](live/api-lifecycle-headers.md). Napi WIP: `docs/live/03_kovetkezo_lepesek.md`.
